...
cat(paste0('<br><li>Biomarker match at the <mark style="background-color:', pcgrr::color_palette[['warning']][['values']][1],'; color:white; font-weight:bold">exon/gene level</mark></li></ul>\n'))
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", variants_tier2_predictive_shared, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical significance", variants_tier2_predictive_shared, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", variants_tier2_predictive_shared, ~BM_EVIDENCE_LEVEL),
    crosstalk::filter_slider("BM_RATING", "Rating", variants_tier2_predictive_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  ),
  list(
    crosstalk::filter_select("CONSEQUENCE", "Consequence", variants_tier2_predictive_shared, ~CONSEQUENCE),
    crosstalk::filter_select("BM_RESOLUTION", "Biomarker resolution", variants_tier2_predictive_shared, ~BM_RESOLUTION),
    crosstalk::filter_select("BM_THERAPEUTIC_CONTEXT", "Therapeutic context", variants_tier2_predictive_shared, ~BM_THERAPEUTIC_CONTEXT)
  )
)
...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", variants_tier2_prognostic_shared, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical significance", variants_tier2_prognostic_shared, ~BM_CLINICAL_SIGNIFICANCE)
  ),
  list(
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", variants_tier2_prognostic_shared, ~BM_EVIDENCE_LEVEL),
    crosstalk::filter_select("BM_RESOLUTION", "Biomarker resolution", variants_tier2_prognostic_shared, ~BM_RESOLUTION),
    crosstalk::filter_slider("BM_RATING", "Rating", variants_tier2_prognostic_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  )
)
cat('The table below lists all variant-evidence item associations:',sep='\n')
htmltools::br()
...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", variants_tier2_diagnostic_shared, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical association", variants_tier2_diagnostic_shared, ~BM_CLINICAL_SIGNIFICANCE)
  ),
  list(
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", variants_tier2_diagnostic_shared, ~BM_EVIDENCE_LEVEL),
    crosstalk::filter_select("BM_RESOLUTION", "Biomarker resolution", variants_tier2_diagnostic_shared, ~BM_RESOLUTION),
    crosstalk::filter_slider("BM_RATING", "Rating", variants_tier2_diagnostic_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  )
)
cat('The table below lists all variant-evidence item associations:',sep='\n')
htmltools::br()
