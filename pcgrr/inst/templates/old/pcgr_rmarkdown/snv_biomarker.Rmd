...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_slider("BM_RATING", "Rating", variants_all_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  ...
  list(
    ...
    crosstalk::filter_select("BM_RESOLUTION", "Biomarker resolution", variants_all_shared, ~BM_RESOLUTION),
