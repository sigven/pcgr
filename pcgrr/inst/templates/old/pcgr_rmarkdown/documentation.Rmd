...
```{r results = "asis", eval = pcg_report$content$mutational_signatures$eval == T & !pcg_report$content$mutational_signatures$missing_data}
...
```{r results = "asis", eval = pcg_report$metadata$config$msigs$run == T & pcg_report$content$mutational_signatures$missing_data}
