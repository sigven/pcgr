...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_slider("N_MAJOR", "Major copy number", other_target_variants, ~N_MAJOR),
    crosstalk::filter_slider("N_MINOR", "Minor copy number", other_target_variants, ~N_MINOR),
  ),
  list(
    crosstalk::filter_select("CHROM", "Chromosome", other_target_variants, ~CHROM),
