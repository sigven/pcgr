...
was trained using __N = 1,066__ exome-sequenced TCGA tumor samples with known 
...
of 100% and a [negative predictive value]({wikipedia_url}Positive_and_negative_predictive_values#Negative_predictive_value) 
of 98.4% on an independent test set of __N = 455__ samples. Details of the MSI 
