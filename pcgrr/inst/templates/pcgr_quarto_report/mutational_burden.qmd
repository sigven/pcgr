...
For TMB calculation, minimum sequencing coverage (__`r pcg_report$settings$conf$somatic_snv$tmb$tmb_dp_min`__) and variant allele frequency (VAF) thresholds are applied to filter out low-quality variants. 
