...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", cna_predictive_shared_strong, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical significance", cna_predictive_shared_strong, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", cna_predictive_shared_strong, ~BM_EVIDENCE_LEVEL)
  ),
  list(
    crosstalk::filter_select("BM_THERAPEUTIC_CONTEXT", "Therapeutic context", cna_predictive_shared_strong, ~BM_THERAPEUTIC_CONTEXT),
    crosstalk::filter_slider("LogR", "Log-ratio", cna_predictive_shared_strong, ~LOG_R, ticks = F),
    crosstalk::filter_slider("BM_RATING", "Rating", cna_predictive_shared_strong, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  )
)
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", cna_prognostic_shared_strong, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical significance", cna_prognostic_shared_strong, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_slider("BM_RATING", "Rating", cna_prognostic_shared_strong, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  ),
  list(
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", cna_prognostic_shared_strong, ~BM_EVIDENCE_LEVEL),
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", cna_diagnostic_shared_strong, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical association", cna_diagnostic_shared_strong, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_slider("BM_RATING", "Rating", cna_diagnostic_shared_strong, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  ),
  list(
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", cna_diagnostic_shared_strong, ~BM_EVIDENCE_LEVEL),
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", cna_predictive_shared, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical significance", cna_predictive_shared, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", cna_predictive_shared, ~BM_EVIDENCE_LEVEL)
  ),
  list(
    crosstalk::filter_select("BM_THERAPEUTIC_CONTEXT", "Therapeutic context", cna_predictive_shared, ~BM_THERAPEUTIC_CONTEXT),
    crosstalk::filter_slider("LOG_R", "Log-ratio", cna_predictive_shared, ~LOG_R, ticks = F),
    crosstalk::filter_slider("BM_RATING", "Rating", cna_predictive_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  )
)
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", cna_prognostic_shared, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical significance", cna_prognostic_shared, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_slider("BM_RATING", "Rating", cna_prognostic_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  ),
  list(
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", cna_prognostic_shared, ~BM_EVIDENCE_LEVEL),
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("BM_CANCER_TYPE", "Cancer type", cna_diagnostic_shared, ~BM_CANCER_TYPE),
    crosstalk::filter_select("BM_CLINICAL_SIGNIFICANCE", "Clinical association", cna_diagnostic_shared, ~BM_CLINICAL_SIGNIFICANCE),
    crosstalk::filter_slider("BM_RATING", "Rating", cna_diagnostic_shared, ~BM_RATING, min = 0, max = 5, step = 1, ticks = T)
  ),
  list(
    crosstalk::filter_select("BM_EVIDENCE_LEVEL", "Evidence level", cna_diagnostic_shared, ~BM_EVIDENCE_LEVEL),
