...
::: {.callout-note title="Tumor-only filtering settings - SNVs/InDels" collapse="true"}

The SNV/InDel variant filtering has been performed based on the following criteria:
...
* Maximum allowed gnomAD MAF's for somatic events (configurable) across all populations:
    * __`r to_settings$gnomad_popmax_af_tolerated`__
