...
report_color <- pcgrr::color_palette$report_color$values[0]
...
flexdashboard::valueBox(
  ...
  color = report_color, icon = "fa-dna")
```
...
flexdashboard::valueBox(
  ...
  icon = "fa-file-prescription", href="#tier-1")
```
...
flexdashboard::valueBox(
  tier2, color = ifelse(
    ...
    pcgrr::color_palette$success,
    pcgrr::color_palette$none), 
  icon = "fa-file-prescription", href="#tier-2")
```
...
* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcgrr::color_palette$tier$values[1]`"><a class="tierlink"  href="#tier-1">&nbsp;TIER 1&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$vstats$n_tier1`</font></b><br>

* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcgrr::color_palette$tier$values[2]`"><a class="tierlink"  href="#tier-2">&nbsp;TIER 2&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$vstats$n_tier2`</font></b><br>

* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcgrr::color_palette$tier$values[3]`"><a class="tierlink"  href="#tier-3">&nbsp;TIER 3&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$vstats$n_tier3`</font></b><br>

* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcgrr::color_palette$tier$values[4]`"><a class="tierlink"  href="#tier-4">&nbsp;TIER 4&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$vstats$n_tier4`</font></b><br>

* <font style="color:white; font-size: 125%;font-weight: bold; background-color:`r pcgrr::color_palette$tier$values[5]`"><a class="tierlink"  href="#tier-5">&nbsp;TIER 5&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$vstats$n_tier5`</font></b>
...
- [**TIER 1: Variants of strong clinical significance**](#tier-1) - constitutes variants linked to predictive, prognostic, or diagnostic biomarkers in the [CIViC database](http://civic.genome.wustl.edu) and the [Cancer Biomarkers Database](https://www.cancergenomeinterpreter.org/biomarkers) that are
	 ...
	 - match between variants in the tumor sample and reported biomarkers must occur at the _exact genomic/amino acid level_ or at the _codon/exon level_
 ...
 - [**TIER 2: Variants of potential clinical significance**](#tier-2) - constitutes other variants linked to predictive, prognostic, or diagnostic biomarkers in the [CIViC database](http://civic.genome.wustl.edu) and the [Cancer Biomarkers Database](https://www.cancergenomeinterpreter.org/biomarkers) that are either
	 ...
	 - overlap between variants in the tumor sample and reported biomarkers must occur at the _exact genomic/amino acid level_ or at the _codon/exon level_
...
### Global variant datatable - filters {data-padding=15 data-width=400}
...
```{r table_browse_allelic_depth, echo=F, results = "asis", eval = NROW(pcg_report$content$snv_indel$callset$variant_display) > 0}

vars <- pcg_report$content$snv_indel$callset$variant_display
  
if(NROW(pcg_report$content$snv_indel$callset$variant_display) > 4000){
  cat('<b>NOTE - listing top 2000 variants</b><br>',sep="\n")
  cat('<br>')
  vars <- pcg_report$content$snv_indel$callset$variant_display <- head(pcg_report$content$snv_indel$callset$variant_display, 4000)
}
  ...
  dplyr::select(
    dplyr::any_of(
      c("SYMBOL", "CONSEQUENCE", "PROTEIN_CHANGE", 
        ...
        "GENOME_VERSION", "ONCOGENICITY", 
        "CALL_CONFIDENCE", "DP_TUMOR", 
        "VAF_TUMOR", "DP_CONTROL", "AF_CONTROL")
      )) |>
  dplyr::arrange(TIER) |>
  dplyr::mutate(
...
if(any(!is.na(vars$CALL_CONFIDENCE))){
  filter_set1[[i_set1]] <- crosstalk::filter_select(
    ...
    variants_shared, ~CALL_CONFIDENCE)
  i_set1 <- i_set1 + 1
}
if(any(!is.na(vars$DP_TUMOR)) & any(!is.na(vars$VAF_TUMOR))){
...
```{r table_browse, eval = NROW(pcg_report$content$snv_indel$callset$variant_display) > 0}
  ...
  DT::datatable(
   ...
   DT::formatStyle(
     ...
     backgroundColor = DT::styleEqual(
       tiers, 
       head(pcgrr::color_palette[['tier']][['values']],5)), 
