...
flexdashboard::valueBox(
  paste0(pcg_report$content$tmb$vstats$tmb_estimate," mut/Mb"), 
  color = col,
  icon = "fa-dna")
```
...
tmb_site_colors <- 
  data.frame(primary_site = unique(tmb_reference$primary_site), stringsAsFactors = F) |>
...
tmb_plot_site <-
  ...
  ggplot2::theme(legend.title = ggplot2::element_blank(),
                 ...
                 ggplot2::geom_hline(yintercept=as.numeric(tmb_estimate), size=0.9, 
                                     linetype = 4, color = pcgrr::color_palette[['tier']][['values']][1])
...
p <- ggplot2::ggplot(
  ...
  ggplot2::geom_histogram(
    mapping = ggplot2::aes(x = fracIndels, color = MSI_status, fill = MSI_status),
