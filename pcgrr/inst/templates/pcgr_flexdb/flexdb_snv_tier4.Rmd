...
```{r}
flexdashboard::valueBox(pcg_report$content$snv_indel$vstats$n_tier4, color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```

### SNVs

```{r}
flexdashboard::valueBox(as.character(n_tier4_snv), color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```

### InDels

```{r}
flexdashboard::valueBox(as.character(n_tier4_indel), color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```

### Block substitutions

```{r}
flexdashboard::valueBox(as.character(n_tier4_block), color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```
