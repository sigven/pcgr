...
flexdashboard::valueBox(paste(pcg_report$content$snv_indel$vstats$n_snv, 
                               ...
                               sep = " / "),
                               color = pcg_report$settings$conf$visual_reporting$color_palette[['tier']][['values']][1], icon = "fa-dna")
```
...
flexdashboard::valueBox(
  ...
  color = pcg_report$settings$conf$visual_reporting$color_palette[['tier']][['values']][1], 
...
```{r}
flexdashboard::valueBox("None", color = pcg_report$settings$conf$visual_reporting$color_palette[['tier']][['values']][1], icon = "fa-dna")
```
...
flexdashboard::valueBox(paste0(cosine_sim," %"), color = pcg_report$settings$conf$visual_reporting$color_palette[['tier']][['values']][1])
```
...
```{r}
flexdashboard::valueBox(
  pcg_report$content$mutational_signatures$result$contributions$aetiology_keyword[1], color = pcg_report$settings$conf$visual_reporting$color_palette[['tier']][['values']][1], href="#mutational-signatures")
```
