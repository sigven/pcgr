...
```{r cna_gains, echo = F}
flexdashboard::valueBox(pcg_report$content$cna$vstats$n_cna_gain,
                        color = ifelse(pcg_report$content$cna$vstats$n_cna_gain > 0,
...
```{r cna_losses, echo = F}
flexdashboard::valueBox(pcg_report$content$cna$vstats$n_cna_loss,
                        color = ifelse(pcg_report$content$cna$vstats$n_cna_loss > 0,
                                       pcg_report$settings$conf$visual_reporting$color_value_box,
                                       pcg_report$settings$conf$visual_reporting$color_none),
                        icon = "fa-dna")
```
...
flexdashboard::valueBox(num_bms1, color = ifelse(num_bms1 > 0,
                        "#00a65a",
                        pcg_report$settings$conf$visual_reporting$color_none), href = "#tier-1-1", icon = "fa-file-prescription")
```
...
flexdashboard::valueBox(num_bms2, color = ifelse(num_bms2 > 0,
                        "#00a65a",
                        pcg_report$settings$conf$visual_reporting$color_none), href = "#tier-2-1", icon = "fa-file-prescription")
```
