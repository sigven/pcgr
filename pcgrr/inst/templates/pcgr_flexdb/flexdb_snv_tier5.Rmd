...
```{r}
flexdashboard::valueBox(pcg_report$content$snv_indel$vstats$n_noncoding, color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```

### SNVs

```{r}
flexdashboard::valueBox(as.character(n_noncoding_snv), color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```

### InDels

```{r}
flexdashboard::valueBox(as.character(n_noncoding_indel), color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```

### Block substitutions

```{r}
flexdashboard::valueBox(as.character(n_noncoding_block), color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```
...
```{r table_browse_noncoding, echo=F, results = "asis", eval = pcg_report$content$snv_indel$vstats$n_noncoding > 0}
...
```{r noncoding_missing_filters, echo=F, results = 'asis', eval = pcg_report$content$snv_indel$vstats$n_noncoding == 0}
...
```{r table_noncoding, eval = pcg_report$content$snv_indel$vstats$n_noncoding > 0}
...
```{r noncoding_missing_data, echo=F, results = 'asis', eval = pcg_report$content$snv_indel$vstats$n_noncoding == 0}
cat('\n*  <i> <font style="font-size: 110%"><b>No</b> noncoding variants found.</font></i>', sep = '\n')
cat('\n')
```
