...
```{r}
flexdashboard::valueBox(pcg_report$content$tumor_only$v_stat$unfiltered_n, color = pcg_report$metadata$color_value_box, icon = "fa-dna")
```
...
```{r}
flexdashboard::valueBox(pcg_report$content$tumor_only$v_stat$nonexonic_n_remain, color = pcg_report$metadata$color_value_box, icon = "fa-dna")
```
