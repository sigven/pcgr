...
```{r}
flexdashboard::valueBox(pcg_report$content$tumor_only$vstats$unfiltered_n, color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```
...
```{r}
flexdashboard::valueBox(pcg_report$content$tumor_only$vstats$nonexonic_n_remain, color = pcg_report$settings$conf$visual_reporting$color_value_box, icon = "fa-dna")
```
