...
flexdashboard::valueBox(
  pcg_report$content$snv_indel$vstats$n_tier3, 
...
flexdashboard::valueBox(
  as.character(
    pcg_report$content$snv_indel$vstats$n_tier3_oncogene), 
  color = pcg_report$settings$conf$report_color, 
  icon = "fa-dna")
```
...
flexdashboard::valueBox(
  as.character(
    pcg_report$content$snv_indel$vstats$n_tier3_tsg), 
  color = pcg_report$settings$conf$report_color, 
  icon = "fa-dna")
```
...
flexdashboard::valueBox(
  as.character(
    pcg_report$content$snv_indel$vstats$n_tier3_dualrole), 
  color = pcg_report$settings$conf$report_color, 
  icon = "fa-dna")
```
