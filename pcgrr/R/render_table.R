...
#'
#' @param value A string with source database names separated by "|"
#' (e.g. "civic|oncokb"), or NA/empty string for no sources.
#'
...
#' (Generated by Claude Opus 4.6 with some manual tweaks)
#'
#' @param value Oncogenicity category (e.g. "Oncogenic",
#' "Likely Oncogenic", etc.)
#'
...
#' (Generated by Claude Opus 4.6 with some manual tweaks)
#'
#' @param value Evidence level value (A, B, C, D, E)
#'
...
#' (Generated by Claude Opus 4.6 with some manual tweaks)
#'
#' @param value Evidence description text
#'
