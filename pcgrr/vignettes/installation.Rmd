...
GENOME="GRCh38" # or "GRCh37"
VEP_VERSION="111"
CACHE="homo_sapiens_vep_${VEP_VERSION}.${GENOME}.tar.gz"

wget https://ftp.ensembl.org/pub/release-111/variation/indexed_vep_cache/${BUNDLE}
gzip -dc ${BUNDLE} | tar xvf -
```
...
The above process takes 10-15 minutes when installing from scratch. In the end, you
