...
- `/Users/you/dir1/VEP_cache` - the directory where you have downloaded the VEP cache (*Note*: this should contain the `homo_sapiens` directory as its child directory)
- `r paste0("/Users/you/dir1/", BUNDLE_VERSION)` - the directory where you have downloaded the PCGR reference bundle (*Note*: this should contain a directory named `data` as its child directory)
