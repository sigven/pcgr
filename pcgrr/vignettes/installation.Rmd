...
- If you know what [conda](https://docs.conda.io/projects/conda/en/latest/user-guide/getting-started.html)
  ...
  software requirements into a local directory:

```bash
cd /Users/you/dir4/conda
PCGR_VERSION="1.4.1.9006"
...
a __cache for VEP__ (Variant Effect Predictor), 
__sample inputs__ (e.g. somatic variants in a VCF), and an
__output directory__ to write the results to.
...
dependencies for these two environments in a local `conda/env` directory in the
following example:
...
is spent on downloading the {BSgenome.Hsapiens.UCSC.hgXX} R packages. In the end, you
...
pcgr       /Users/you/dir4/conda/env/pcgr
pcgrr      /Users/you/dir4/conda/env/pcgrr
```
