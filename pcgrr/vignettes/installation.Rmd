...
```{r vars, echo=FALSE}
Sys.setenv(VEP_VERSION = "116")
Sys.setenv(PCGR_VERSION = "2.3.2.9005")
Sys.setenv(BUNDLE_VERSION = "20260915")
...
[ensembl-ftp]: https://ftp.ensembl.org/pub/release-116/variation/indexed_vep_cache/
...
There is Conda support for Linux machines.
...
<https://github.com/sigven/pcgr/pkgs/container/pcgr>.
Pull the latest **v`r PCGR_VERSION`** image with:

```{r echo=FALSE}
glue("docker pull ghcr.io/sigven/pcgr:{PCGR_VERSION}")
# might need to specify platform
# docker pull --platform=amd64 ghcr.io/sigven/pcgr:${PCGR_VERSION}
```
