...
| 2 | __\<sample_id\>.pcgr.grch37.xlsx__ | An excel workbook with multiple sheets of annotations (Assay & sample info/SNVs & InDels/CNAs/Biomarkers/TMB/MSI), amenable for aggregation analysis across multiple samples |
...
| 6 | __\<sample_id\>.pcgr.grch37.conf.yaml__ | PCGR configuration data (YAML), as generated by pre-reporting annotation workflow |
...
| 9 | __\<sample_id\>.pcgr.grch37.tmb.tsv__ | Tab-separated values file with information on TMB estimates |
| 10 | __\<sample_id\>.pcgr.grch37.snv_indel_ann.tsv.gz__ | Tab-separated values file with key SNV/InDel variant annotations, including oncogenicity/actionability assessment |
