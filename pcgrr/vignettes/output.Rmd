...
PCGR generates multiple output files with annotations of molecular aberrations, 
including an interactive report, an Excel workbook, and pure text-based 
annotation files.
...
| 12. `LOSS_OF_FUNCTION` | Loss of function flag - From LOFTEE (high confidence) |
...
| 18. `ACTIONABILITY_TIER` | Actionability tier |
| 19. `ACTIONABILITY` | Actionability |
| 20. `ACTIONABILITY_FRAMEWORK` | Actionability framework |
