...
| Tag | Description |
|-----|-------------|
| `AFR_AF_GNOMAD` | African/American germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `AMR_AF_GNOMAD` | American germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `GLOBAL_AF_GNOMAD` | Adjusted global germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `SAS_AF_GNOMAD` | South Asian germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `EAS_AF_GNOMAD` | East Asian germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `FIN_AF_GNOMAD` | Finnish germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `NFE_AF_GNOMAD` | Non-Finnish European germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `OTH_AF_GNOMAD` | Other germline allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
| `ASJ_AF_GNOMAD` | Ashkenazi Jewish allele frequency ([gnomAD release 2](http://gnomad.broadinstitute.org/)) |
