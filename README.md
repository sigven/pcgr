...
### Example reports
* [Report for a breast tumor sample (TCGA)](http://folk.uio.no/sigven/tumor_sample.BRCA.0.5.1.1.pcgr.html)
* [Report for a colon adenocarcinoma sample (TCGA)](http://folk.uio.no/sigven/tumor_sample.COAD.0.5.1.1.pcgr.html)
...
### Annotation resources included in PCGR (v0.5.1.1)
...
1. Download and unpack the [latest software release (0.5.1.1)](https://github.com/sigven/pcgr/releases/latest)
...
3. Pull the [PCGR Docker image (0.5.1.1)](https://hub.docker.com/r/sigven/pcgr/) from DockerHub (approx 4.2Gb):
...
` ~/pcgr-0.5.1.1 ~/pcgr-0.5.1.1/examples ~/pcgr-0.5.1.1/examples/pcgr_configuration.toml tumor_sample.COAD`
