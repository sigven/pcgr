...
2. Install the PCGR Python component on your local machine. Only requirement is Python > 3.6.
  ...
  Or else it will (probably) use your system's Python and you'll end up in a situations like <https://xkcd.com/1987/>.
...
/Users/pdiakumis/conda/envs/pcgr_docker/bin/pcgr
