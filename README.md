...
### Annotation resources included in PCGR (v0.4.0)
...
__August 4th 2017__: New release (0.4.0)

1. Download and unpack the [latest software release (0.4.0)](https://github.com/sigven/pcgr/releases/latest)
...
3. Pull the [PCGR Docker image (0.4.0)](https://hub.docker.com/r/sigven/pcgr/) from DockerHub (3.3Gb):
