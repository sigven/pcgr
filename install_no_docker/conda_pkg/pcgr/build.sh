...
which tar
which zip
ln -s $(which tar) /bin/gtar
ln -s $(which zip) /bin/gzip
R -e "library(devtools); options(unzip = '$(which unzip)'); devtools::install_github('rstudio/crosstalk', dependencies=FALSE)"
