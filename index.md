...
resources](https://sigven.github.io/pcgr/articles/annotation_resources.md)
...
- [Installation
  instructions](https://sigven.github.io/pcgr/articles/installation.md)

- [Run through an
  example](https://sigven.github.io/pcgr/articles/running.html#example-run)

- Learn more about:

  1.  Details regarding [PCGR input
      files](https://sigven.github.io/pcgr/articles/input.md), and how
      they should be formatted
  2.  Configuration of [key
      settings](https://sigven.github.io/pcgr/articles/running.md)
  3.  The types and contents of [PCGR output
      files](https://sigven.github.io/pcgr/articles/output.md)
  4.  [Variant classifications implemented in
      PCGR](https://sigven.github.io/pcgr/articles/variant_classification.md)
  5.  [Primary tumor sites used in
      PCGR](https://sigven.github.io/pcgr/articles/primary_tumor_sites.md)
  6.  The list of [gene and variant annotation
      resources](https://sigven.github.io/pcgr/articles/annotation_resources.md)
      used in PCGR annotation

- [Frequently asked questions
  (FAQ)](https://sigven.github.io/pcgr/articles/faq.md)
