...
def extend_vcf_annotations(query_vcf, pcgr_db_directory, logger, pon_annotation, cpsr):
   ...
   pcgr_onco_xref_map = {'ENSEMBL_TRANSCRIPT_ID': 0, 'ENSEMBL_GENE_ID':1, 
                        'ENSEMBL_PROTEIN_ID':2, 
                        'SYMBOL':3, 'SYMBOL_ENTREZ':4, 
                        'ENTREZ_ID':5, 'UNIPROT_ID':6, 'APPRIS':7,'UNIPROT_ACC':8,
                        'REFSEQ_MRNA':9,'CORUM_ID':10,'TUMOR_SUPPRESSOR':11,
                        'TUMOR_SUPPRESSOR_EVIDENCE':12, 'ONCOGENE':13, 'ONCOGENE_EVIDENCE':14,
                        'NETWORK_CG':15,'CHEMBL_COMPOUND_ID':16, 'INTOGEN_DRIVER':17,
                        'TCGA_DRIVER':18, 'MIM_PHENOTYPE_ID':19, 'CANCER_PREDISPOSITION_SOURCE':20, 
                        'CANCER_SUSCEPTIBILITY_CUI':21, 'CANCER_SYNDROME_CUI':22, 
                        'CANCER_PREDISPOSITION_MOI':23, 
                        'CANCER_PREDISPOSITION_MOD':24, 'SIGNALING_PATHWAY':25, 'OPENTARGETS_DISEASE_ASSOCS':26,
                        'OPENTARGETS_TRACTABILITY_COMPOUND':27, 'OPENTARGETS_TRACTABILITY_ANTIBODY':28, 'GE_PANEL_ID':29, 
                        'ACTIONABLE_TARGET':30, 'GENCODE_GENE_STATUS':31,
                        'PROB_HAPLOINSUFFICIENCY':32, 'PROB_EXAC_LOF_INTOLERANT':33, 'PROB_EXAC_LOF_INTOLERANT_HOM':34,
                        'PROB_EXAC_LOF_TOLERANT_NULL':35, 'PROB_EXAC_NONTCGA_LOF_INTOLERANT':36,
                        'PROB_EXAC_NONTCGA_LOF_INTOLERANT_HOM':37, 'PROB_EXAC_NONTCGA_LOF_TOLERANT_NULL':38,
                        'PROB_GNOMAD_LOF_INTOLERANT':39, 'PROB_GNOMAD_LOF_INTOLERANT_HOM':40, 'PROB_GNOMAD_LOF_TOLERANT_NULL':41,
                        'ESSENTIAL_GENE_CRISPR':42, 'ESSENTIAL_GENE_CRISPR2':43}
