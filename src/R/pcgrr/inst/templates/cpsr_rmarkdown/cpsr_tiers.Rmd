...
variants_class5_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class5']], SOURCE == 'ClinVar')
...
variants_class5_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class5']], SOURCE == 'Other')
...
variants_class4_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class4']], SOURCE == 'ClinVar')
...
variants_class4_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class4']], SOURCE == 'Other')
...
variants_class3_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class3']], SOURCE == 'ClinVar')
...
variants_class3_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class3']], SOURCE == 'Other')
...
variants_class2_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class2']], SOURCE == 'ClinVar')
...
variants_class2_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class2']], SOURCE == 'Other')
...
variants_class1_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class1']], SOURCE == 'ClinVar')
...
variants_class1_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][["disp"]][['class1']], SOURCE == 'Other')
