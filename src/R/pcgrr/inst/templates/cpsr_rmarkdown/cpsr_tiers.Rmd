...
for(c in c('class1','class2','class3','class4','class5')){
  ...
  for(m in c('Other','ClinVar')){
    ...
    if(NROW(cps_report[['content']][['snv_indel']][['variant_display']][[c]]) > 0){
      tot_variants[[c]][[m]] <- NROW(cps_report[['content']][['snv_indel']][['variant_display']][[c]] %>% 
                                     dplyr::filter(SOURCE == m))
    }
...
### <span style="color:`r pcgrr::significance_colors[1]`">Class 5 - <b>Pathogenic</b> variants</span> {.tabset .tabset-pills .nav-justified}
...
variants_class5_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class5']], SOURCE == 'ClinVar')

if(NROW(variants_class5_clinvar) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (due to limitations with client-side tables) </b><br>',sep="\n")
  cat('<br>')
  variants_class5_clinvar <- 
    head(variants_class5_clinvar, 5000)
}

variants_class5_clinvar <- variants_class5_clinvar %>% 
  dplyr::select(-c(CPSR_CLASSIFICATION,CPSR_CLASSIFICATION_SCORE,
...
variants_class5_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class5']], SOURCE == 'Other')

if(NROW(variants_class5_other) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (ranked according to CPSR classification score) </b><br>',sep="\n")
  cat('<br>')
  variants_class5_other <- 
    head(variants_class5_other, 5000)
}
...
### <span style="color:`r pcgrr::significance_colors[2]`">Class 4 - <b>Likely Pathogenic</b> variants</span> {.tabset .tabset-pills .nav-justified}
...
variants_class4_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class4']], SOURCE == 'ClinVar')

if(NROW(variants_class4_clinvar) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (due to limitations with client-side tables) </b><br>',sep="\n")
  cat('<br>')
  variants_class4_clinvar <- 
    head(variants_class4_clinvar, 5000)
}
...
variants_class4_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class4']], SOURCE == 'Other')

if(NROW(variants_class4_other) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (ranked according to CPSR classification score) </b><br>',sep="\n")
  cat('<br>')
  variants_class4_other <- 
    head(variants_class4_other, 5000)
}
...
### <span style="color:`r pcgrr::significance_colors[3]`">Class 3 - <b>Variants of Uncertain Significance (VUS)</b></span> {.tabset .tabset-pills .nav-justified}
...
variants_class3_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class3']], SOURCE == 'ClinVar')

if(NROW(variants_class3_clinvar) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (due to limitations with client-side tables) </b><br>',sep="\n")
  cat('<br>')
  variants_class3_clinvar <- 
    head(variants_class3_clinvar, 5000)
}
...
variants_class3_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class3']], SOURCE == 'Other')

if(NROW(variants_class3_other) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (ranked according to CPSR classification score) </b><br>',sep="\n")
  cat('<br>')
  variants_class3_other <- 
    head(variants_class3_other, 5000)
}
...
### <span style="color:`r pcgrr::significance_colors[4]`">Class 2 - <b>Likely Benign</b> variants</span> {.tabset .tabset-pills .nav-justified}
...
variants_class2_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class2']], SOURCE == 'ClinVar')

if(NROW(variants_class2_clinvar) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (due to limitations with client-side tables) </b><br>',sep="\n")
  cat('<br>')
  variants_class2_clinvar <- 
    head(variants_class2_clinvar, 5000)
}
...
variants_class2_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class2']], SOURCE == 'Other')

if(NROW(variants_class2_other) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (ranked according to CPSR classification score) </b><br>',sep="\n")
  cat('<br>')
  variants_class2_other <- 
    head(variants_class2_other, 5000)
}
...
### <span style="color:`r pcgrr::significance_colors[5]`">Class 1 - <b>Benign</b> variants</span> {.tabset .tabset-pills .nav-justified}
...
variants_class1_clinvar <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class1']], SOURCE == 'ClinVar')

if(NROW(variants_class1_clinvar) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (due to limitations with client-side tables) </b><br>',sep="\n")
  cat('<br>')
  variants_class1_clinvar <- 
    head(variants_class1_clinvar, 5000)
}
...
variants_class1_other <- 
  dplyr::filter(cps_report[['content']][['snv_indel']][['variant_display']][['class1']], SOURCE == 'Other')

if(NROW(variants_class1_other) > 5000){
  cat('<b>NOTE - only considering top 5000 variants (ranked according to CPSR classification score) </b><br>',sep="\n")
  cat('<br>')
  variants_class1_other <- 
    head(variants_class1_other, 5000)
}
