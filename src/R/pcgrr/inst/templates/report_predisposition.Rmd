...
### Variant statistics - selected cancer predisposition genes (n = `r cps_report[['snv_indel']][['n_predisposition_genes']]` )
...
* Number of noncoding variants: __`r pcg_report[['snv_indel']][['variant_statistic_cpg']][['n_noncoding']]`__
