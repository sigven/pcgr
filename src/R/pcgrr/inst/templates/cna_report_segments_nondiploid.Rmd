...
* <span style="color:#009E73"><b>Copy number amplifications</b></span>: Log(2) ratio >= `r pcg_report[['metadata']][['config']][['cna']][['logR_gain']]`
* <span style="color:red"><b>Homozygous deletions</b></span>: Log(2) ratio <= `r pcg_report[['metadata']][['config']][['cna']][['logR_homdel']]`
...
if(NROW(pcg_report[['content']][['cna']][['variant_display']][['segment']]) > 0){
  cna_segments <- dplyr::rename(pcg_report[['content']][['cna']][['variant_display']][['segment']], Segment = SEGMENT, Length_Mb = SEGMENT_LENGTH_MB, Cytoband = cytoband, Event_type = event_type)
...
crosstalk::bscols(
  ...
  DT::formatStyle('LogR',color='white', backgroundColor = DT::styleInterval(pcg_report[['metadata']][['config']][['cna']][['logR_homdel']], c('red', '#009E73')))
)
