...
* <span style="color:#009E73"><b>Copy number amplifications</b></span>: Log(2) ratio >= `r pcgr_config$cna$logR_gain`
* <span style="color:red"><b>Homozygous deletions</b></span>: Log(2) ratio <= `r pcgr_config$cna$logR_homdel`
...
crosstalk::bscols(
  ...
  DT::formatStyle('LogR',color='white', backgroundColor = DT::styleInterval(pcgr_config$cna$logR_homdel, c('red', '#009E73')))
)
