...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_select("CANCER_MUTATION_HOTSPOT", "Mutation hotspot", variants_tsgene_shared, ~CANCER_MUTATION_HOTSPOT)
  ),
  list(
...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_select("CANCER_MUTATION_HOTSPOT", "Mutation hotspot", variants_oncogene_shared, ~CANCER_MUTATION_HOTSPOT)
  ),
  list(
