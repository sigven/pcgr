...
for(type in c('diagnostic','prognostic','predictive')){
  ...
  if(NROW(pcg_report[['content']][['snv_indel']][['clinical_evidence_item']][['other_tumortype']][[type]][['A_B']]) > 0 | NROW(pcg_report[['content']][['snv_indel']][['clinical_evidence_item']][['specific_tumortype']][[type]][['C_D_E']]) > 0){
    eitems[[type]] <- dplyr::bind_rows(pcg_report[['content']][['snv_indel']][['clinical_evidence_item']][['other_tumortype']][[type]][['A_B']], pcg_report[['content']][['snv_indel']][['clinical_evidence_item']][['specific_tumortype']][[type]][['C_D_E']]) %>%
