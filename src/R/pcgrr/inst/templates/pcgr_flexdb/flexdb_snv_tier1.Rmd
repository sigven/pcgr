...
```{r}
flexdashboard::valueBox(pcg_report$content$snv_indel$variant_statistic$n_tier1, 
...
```{r table_browse_tier1, echo=F, results = "asis", eval = pcg_report$content$snv_indel$variant_statistic$n_tier1 > 0}
...
```{r biomarker_note1, echo=F, results = "asis", include = pcg_report$content$snv_indel$variant_statistic$n_tier1 > 0}
...
```{r tier1_missing_filters, echo=F, results = 'asis', eval = pcg_report$content$snv_indel$variant_statistic$n_tier1 == 0}
...
```{r table_tier1, eval = pcg_report$content$snv_indel$variant_statistic$n_tier1 > 0}
...
```{r tier1_missing_data, echo=F, results = 'asis', eval = pcg_report$content$snv_indel$variant_statistic$n_tier1 == 0}
cat('\n*  <i> <font style="font-size: 110%"><b>No</b> variants of strong clinical significance found.</i></font>',sep='\n')
cat('\n')
```
