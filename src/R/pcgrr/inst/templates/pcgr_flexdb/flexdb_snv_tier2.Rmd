...
```{r}
flexdashboard::valueBox(pcg_report$content$snv_indel$variant_statistic$n_tier2, color = pcg_report$metadata$color_value_box, icon = "fa-dna")
```
...
```{r table_browse_tier2, echo=F, results = "asis", eval = pcg_report$content$snv_indel$variant_statistic$n_tier2 > 0}
...
```{r tier2_missing_filters, echo=F, results = 'asis', eval = pcg_report$content$snv_indel$variant_statistic$n_tier2 == 0}
...
```{r table_tier2, eval = pcg_report$content$snv_indel$variant_statistic$n_tier2 > 0}
 ...
 DT::datatable(escape = F, 
  ...
  DT::formatStyle(color="white", "SYMBOL", "BIOMARKER_MAPPING", fontWeight = 'bold', `text-align` = 'center',
                  backgroundColor = DT::styleEqual(c('exact','codon','exon','gene'), 
                                                   c('#000','#000',pcgrr::color_warning, pcgrr::color_warning)))

```

```{r tier2_missing_data, echo=F, results = 'asis', eval = pcg_report$content$snv_indel$variant_statistic$n_tier2 == 0}
cat('\n*  <i> <font style="font-size: 110%"><b>No</b> variants of potential clinical significance found.</font></i>', sep = '\n')
cat('\n')
```
