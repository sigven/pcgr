...
```{r}
flexdashboard::valueBox(pcg_report$content$snv_indel$variant_statistic$n_snv, color = pcg_report$metadata$color_value_box, icon = "fa-dna")
```

### InDels

```{r}
flexdashboard::valueBox(pcg_report$content$snv_indel$variant_statistic$n_indel, color = pcg_report$metadata$color_value_box, icon = "fa-dna")
```

### TIER 1 variants

```{r}
tier1 <- pcg_report$content$snv_indel$variant_statistic$n_tier1
...
```{r}
tier2 <- pcg_report$content$snv_indel$variant_statistic$n_tier2
...
* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcg_report[['metadata']][['color_palette']][['tier']][['values']][1]`"><a class="tierlink"  href="#tier-1">&nbsp;TIER 1&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$variant_statistic$n_tier1`</font></b><br>

* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcg_report[['metadata']][['color_palette']][['tier']][['values']][2]`"><a class="tierlink"  href="#tier-2">&nbsp;TIER 2&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$variant_statistic$n_tier2`</font></b><br>

* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcg_report[['metadata']][['color_palette']][['tier']][['values']][3]`"><a class="tierlink"  href="#tier-3">&nbsp;TIER 3&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$variant_statistic$n_tier3`</font></b><br>

* <font style="color:white; font-size: 125%; font-weight: bold; background-color:`r pcg_report[['metadata']][['color_palette']][['tier']][['values']][4]`"><a class="tierlink"  href="#tier-4">&nbsp;TIER 4&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$variant_statistic$n_tier4`</font></b><br>

* <font style="color:white; font-size: 125%;font-weight: bold; background-color:`r pcg_report[['metadata']][['color_palette']][['tier']][['values']][5]`"><a class="tierlink"  href="#noncoding">&nbsp;NONCODING&nbsp;&nbsp;</font></a> <b><font style="font-size: 125%">:&nbsp;`r pcg_report$content$snv_indel$variant_statistic$n_noncoding`</font></b>
...
cat("<br>")
cat('*   <i>Tumor sequencing depth and allelic fraction of variants not provided - omitting plot.</i>',sep='\n')
cat('<br>')
...
if(NROW(pcg_report[['content']][['snv_indel']][['variant_set']][['tsv']]) > 5000){
