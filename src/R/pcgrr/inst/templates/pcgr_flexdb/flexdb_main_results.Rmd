...
* Tumor type: <b> __`r pcg_report[['metadata']][['config']][['tumor_properties']][['tumor_type']]`__ </b>
* Sequencing mode input (VCF): <b> __`r pcg_report[['metadata']][['config']][['assay_properties']][['mode']]`__ </b>
* Sequencing type input (VCF): <b> __`r pcg_report[['metadata']][['config']][['assay_properties']][['type']]`__ </b>
* Coding target size (VCF): <b> __`r pcg_report[['metadata']][['config']][['assay_properties']][['target_size_mb']]` Mb__ </b>
...
```{r fig.width = 3.5}
flexdashboard::valueBox(paste(pcg_report$content$snv_indel$variant_statistic$n_snv, 
                               pcg_report$content$snv_indel$variant_statistic$n_indel,
                               sep = " / "),
...
```{r fig.width = 3.5}
flexdashboard::valueBox(paste(pcg_report$content$cna$variant_statistic$n_cna_loss, 
                               pcg_report$content$cna$variant_statistic$n_cna_gain,sep=" / "), 
                               color = pcg_report[['metadata']][['color_palette']][['tier']][['values']][1], icon = "fa-dna",
                        href = "#overview-2")
```
