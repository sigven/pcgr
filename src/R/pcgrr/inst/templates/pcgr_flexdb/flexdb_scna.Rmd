...
```{r cna_gains, echo = F}
flexdashboard::valueBox(pcg_report$content$cna$variant_statistic$n_cna_gain,
                        color = ifelse(pcg_report$content$cna$variant_statistic$n_cna_gain > 0,
...
```{r cna_losses, echo = F}
flexdashboard::valueBox(pcg_report$content$cna$variant_statistic$n_cna_loss,
                        color = ifelse(pcg_report$content$cna$variant_statistic$n_cna_loss > 0,
                                       pcg_report$metadata$color_value_box,
                                       pcg_report$metadata$color_none),
                        icon = "fa-dna")
```
...
```{r cna_tier1, echo = F}
num_bms1 <- NROW(pcg_report[["content"]][["cna"]][["variant_display"]][["tier1"]])
...
```{r cna_tier2, echo = F}
num_bms2 <- NROW(pcg_report[["content"]][["cna"]][["variant_display"]][["tier2"]])
...
* <span style="background-color:#00a65a; color:white"><b>&nbsp; Copy number amplifications </b></span>&nbsp; : Log(2) ratio >= **`r pcg_report[["metadata"]][["config"]][["cna"]][["logR_gain"]]`**

* <span style="background-color:#CD534CFF; color:white"><b>&nbsp; Homozygous deletions </b></span>&nbsp; : Log(2) ratio <= **`r pcg_report[["metadata"]][["config"]][["cna"]][["logR_homdel"]]`**
...
DT::datatable(cna_segments_sd, extensions=c("Buttons","Responsive"),
              ...
              options = list(pageLength = 10, 
                             ...
                             dom = "Bfrtip")) %>%
DT::formatStyle("LOG_R",color="white", `text-align` = 'center', fontWeight = "bold", backgroundColor = DT::styleInterval(pcg_report[["metadata"]][["config"]][["cna"]][["logR_homdel"]], c("#CD534CFF", "#00a65a")))


```


```{r scna_missing_global, echo=F, results = 'asis', eval = NROW(pcg_report$content$cna$variant_display$segment) == 0}
...
<font style="color:white; font-size: 115%; font-weight: bold">
  ...
  **  [ - Proto-oncogenes subject to amplifications: `r NROW(pcg_report[["content"]][["cna"]][["variant_display"]][["oncogene_gain"]])`](#scna-oncogene)**

  **  [ - Tumor suppressor genes subject to homozygous deletions: `r NROW(pcg_report[["content"]][["cna"]][["variant_display"]][["tsgene_loss"]])`](#scna-tsgene)**

  **  [ - Other drug targets subject to amplification: `r NROW(pcg_report[["content"]][["cna"]][["variant_display"]][["other_target"]])`](#scna-other)**
