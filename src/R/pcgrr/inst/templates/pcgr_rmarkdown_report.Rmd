...
nocite: |
  ...
  @Blokzijl2018-nc, @Lever2019-xp, @Repana2019-dd, @Chalmers2017-cz, @Yin2020-or, @Bailey2018-os
output: 
  html_document:
    toc: true
    theme: default
...
cat("\nThe number of SNV/InDel calls (n = ",pcg_report[['content']][['snv_indel']][['variant_statistic']][['n_coding']], 
