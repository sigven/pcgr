...
crosstalk::bscols(
  ...
  list(
    crosstalk::filter_select("CONSEQUENCE", "Consequence", variants_shared, ~CONSEQUENCE),
    crosstalk::filter_slider_allelic_fraction("AF_TUMOR", "Allelic fraction tumor", variants_shared, ~AF_TUMOR, step=0.05, ticks = T, sep = F)
...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_slider_allelic_fraction("AF_TUMOR", "Allelic fraction tumor", variants_shared, ~AF_TUMOR, step=0.05, sep=F, ticks = T)
  ),
  list(
    crosstalk::filter_select("CONSEQUENCE", "Consequence", variants_shared, ~CONSEQUENCE),
    crosstalk::filter_slider("DP_NORMAL", "Sequencing depth control", variants_shared, ~DP_NORMAL, sep=F, ticks = F),
    crosstalk::filter_slider_allelic_fraction("AF_NORMAL", "Allelic fraction control", variants_shared, ~AF_NORMAL, step=0.05, sep=F, ticks = T)
  )
)
