...
* PM4 (<b>2</b>) - Protein length changes due to inframe indels or stoploss variants in non-repetitive regions (as identified by RepeatMasker) of known susceptibility gene (dominant MoI)
...
* PPC1 (<b>1</b>) - Protein length changes due to inframe indels or stoploss variants in non-repetitive regions (as identified by RepeatMasker) of known susceptibility gene (recessive MoI)
