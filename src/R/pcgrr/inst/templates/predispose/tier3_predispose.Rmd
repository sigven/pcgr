...
The unclassified, coding variants have all been assigned a composite <i>pathogenicity score</i> (coined <b>PATHSCORE</b> in the tables below) according to the prioritization scheme developed in [CharGer](https://github.com/ding-lab/charger/) ([Huang et al., 2018](https://www.ncbi.nlm.nih.gov/pubmed/29625052)). Specifially, a cancer-specific adoption of previously established <b>ACMG</b> criteria for variant classification ([Richards et al., 2015](https://www.ncbi.nlm.nih.gov/pubmed/25741868)) has been implemented. The following ACMG evidence items indicate support for pathogenic/benign variants, and have been implemented as follows (points in parenthesis indicate how they contribute to overall PATHSCORE):  

* PVS1 (<b>8</b>) - null variant (nonsense, frameshift, canonical ±1 or 2 splice sites, initiation codon) in a gene where LoF is a known mechanism of disease (dominant mode of inheritance, tumor supressor genes only)
...
* PSC1 (<b>4</b>) - null variant (nonsense, frameshift, canonical ±1 or 2 splice sites, initiation codon) in a gene where LoF is a known mechanism of disease (recessive mode of inheritance, tumor suppressor genes only)
* PMC1 (<b>2</b>) - null variant (nonsense, frameshift, canonical ±1 or 2 splice sites, initiation codon) in known susceptibility gene (non-tumor suppressor)
...
* PP2 (<b>1</b>) - Missense variant in known susceptibility gene
