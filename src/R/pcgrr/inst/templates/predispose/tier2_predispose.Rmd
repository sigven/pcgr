...
tot_variants_lp_clinvar <- NROW(pcg_report[['snv_indel']][['variant_display']][['tier2']][['cancer_phenotype']]) + NROW(pcg_report[['snv_indel']][['variant_display']][['tier2']][['noncancer_phenotype']])
...
cat('A total of <b>',NROW(pcg_report[['snv_indel']][['variant_display']][['tier2']][['cancer_phenotype']]), '</b> unique, germline variant(s) are found as likely pathogenic and associated with cancer phenotypes in ClinVar for the selected predisposition genes:')
cat('\n')
htmltools::br()
htmltools::br()
...
cat('A total of <b>',NROW(pcg_report[['snv_indel']][['variant_display']][['tier2']][['noncancer_phenotype']]), '</b> unique, germline variant(s) are found as pathogenic and associated with undefined/non-cancer phenotypes in ClinVar for the selected predisposition genes:')
cat('\n')
htmltools::br()
htmltools::br()
