...
while(i <= NROW(cps_report[['summary']][['tier1']])){
  cat(paste0('<li><span style="color:#9E0142; font-size:13pt">',cps_report[['summary']][['tier1']][i,]$CLINVAR_PHENOTYPE,'</span> - ',cps_report[['summary']][['tier1']][i,]$VARIANTS),'</li>\n')
  i <- i + 1
}
cat('</ul>\n')
```
...
while(i <= NROW(cps_report[['summary']][['tier2']])){
  cat(paste0('<li><span style="color:#D53E4F; font-size:13pt">',cps_report[['summary']][['tier2']][i,]$CLINVAR_PHENOTYPE,'</span> - ',cps_report[['summary']][['tier2']][i,]$VARIANTS),'</li>\n')
  i <- i + 1
}
cat('</ul>\n')
