...
if(NROW(pcg_report[['content']][['cna']][['variant_display']][['oncogene_gain']]) >= 10){
...
if(NROW(pcg_report[['content']][['cna']][['variant_display']][['oncogene_gain']]) > 0){
  DT::datatable(pcg_report[['content']][['cna']][['variant_display']][['oncogene_gain']], options = myOptions, escape=F, extensions = "Responsive")
}
```
