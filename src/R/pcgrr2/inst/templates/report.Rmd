...
params:
  ...
  logR_threshold_amplification: 1
  logR_threshold_homozygous_deletion: -1
...
```{r conditional_print6b, child='cna_report_segments_nondiploid.Rmd', eval = cna_report_segments}
```


```{r conditional_print7, child='cna_report_oncogene_gain.Rmd', eval = cna_report_oncogene_gain}
```

```{r conditional_print8, child='cna_report_tsgene_loss.Rmd', eval = cna_report_tsgene_loss}
```

```{r conditional_print9, child='cna_report_biomarkers.Rmd', eval = cna_report_biomarkers}
```
<br>
