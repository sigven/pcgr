...
#' file from DGG Engine/CPSR pre-report (Python) pipeline
#'
#' @param fname Path to raw input file with DNA aberrations (DGG Engine/CPSR)
#' @param cols column type definitions of raw input file
#' @param ref_data DGG Engine reference data object
