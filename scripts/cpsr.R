...
cpsr_config[['required_args']][['output_dir']] <- as.character(args[1])
...
cpsr_config[['required_args']][['cpsr_version']] <- as.character(packageVersion("cpsr"))
cpsr_config[['required_args']][['pcgr_bundle_version']] <- as.character(args[5])
