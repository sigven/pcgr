...
from dgg_engine import utils, pcgr_vars
from dgg_engine.utils import check_subprocess, error_message
from dgg_engine.variant import reverse_complement_dna
...
def read_infotag_file(vcf_info_tags_tsv, scope = "vep"):
    """
    Function that reads a file that lists VCF INFO tags produced by DGG Engine/CPSR/gvanno.
