...
def get_pcgr_bin():
    """Return abs path to e.g. conda/env/dgg_engine/bin
    """
...
def get_maxentscan_dir():
    ...
    """
    share_dir = os.path.join(conda_prefix(), 'share') # /conda/envs/dgg_engine/share
...
def quarto_evars_path(pcgrr_env):
    ...
    which is under /path/to/envs/dgg_engine_r/etc/conda/activate.d
    """
...
def perl_cmd():
    ...
    e.g. conda/env/dgg_engine/bin/perl
    """
...
def get_perl_exports():
    ...
    """
    perl_path = os.path.normpath(perl_cmd())      # /conda/env/dgg_engine/bin/perl
    perl_path_parent = os.path.dirname(perl_path) # /conda/env/dgg_engine/bin
