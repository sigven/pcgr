...
__April 20th 2017__: New release (0.3.3)</font>

* Download and unpack the [latest release (0.3.3)](https://github.com/sigven/pcgr/releases/latest)
...
* Pull the [PCGR Docker image - 0.3.3](https://hub.docker.com/r/sigven/pcgr/) from DockerHub (3.2Gb) :
