...
1. Download and unpack the [latest software release (0.6.3)](https://github.com/sigven/pcgr/releases/tag/v0.6.3)
...
3. Pull the [PCGR Docker image (0.6.3)](https://hub.docker.com/r/sigven/pcgr/) from DockerHub (approx 5.1Gb):
	* `docker pull sigven/pcgr:0.6.3` (PCGR annotation engine)
