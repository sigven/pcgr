...
* Download and unpack the [latest software release (0.5.1.2)](https://github.com/sigven/pcgr/releases/latest)
...
* Pull the [PCGR Docker image - 0.5.1.2](https://hub.docker.com/r/sigven/pcgr/) from DockerHub (approx 4.2Gb) :
