...
__April 22th 2017__: New release (0.3.4)</font>

* Download and unpack the [latest release (0.3.4)](https://github.com/sigven/pcgr/releases/latest)
...
* Pull the [PCGR Docker image - 0.3.4](https://hub.docker.com/r/sigven/pcgr/) from DockerHub (3.2Gb) :
...
`examples/tumor_sample.COAD.cna.tsv ~/pcgr-0.3.4 ~/pcgr-0.3.4/examples tumor_sample.COAD`
