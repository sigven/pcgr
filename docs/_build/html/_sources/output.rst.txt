...
currently supported. This is primarily due to the fact that a number of
the clinical annotation sets are still only available with GRCh37
mapping. Offering support for GRCh38 will have priority in upcoming
releases.
