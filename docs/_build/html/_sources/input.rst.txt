...
be used for interactive exploration in the tumor report.
...
Some features and analysis performed in PCGR must be configured in a
TOML-formatted configuration file. The default TOML configuration file,
with descriptive comments wrt. usage are shown below:
