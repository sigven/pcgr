...
**April 22th 2017**: New release (0.3.4)

-  Download and unpack the `latest release
   (0.3.4) <https://github.com/sigven/pcgr/releases/latest>`__
...
-  Pull the `PCGR Docker image -
   0.3.4 <https://hub.docker.com/r/sigven/pcgr/>`__ from DockerHub
   (3.2Gb) :
