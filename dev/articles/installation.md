...
**v2.2.5.9019** image with:

    docker pull ghcr.io/sigven/pcgr:2.2.5.9019
...
Registry](https://ghcr.io/sigven/pcgr). Pull the latest **v2.2.5.9019**
image with:

    apptainer pull oras://ghcr.io/sigven/pcgr:2.2.5.9019.singularity

This will download a Singularity Image File (SIF) called
**pcgr_2.2.5.9019.singularity.sif** that can be run with Singularity or
Apptainer.
