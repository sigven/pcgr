...
**v2.3.0.9001** image with:

    docker pull ghcr.io/sigven/pcgr:2.3.0.9001
...
Registry](https://ghcr.io/sigven/pcgr). Pull the latest **v2.3.0.9001**
image with:

    apptainer pull oras://ghcr.io/sigven/pcgr:2.3.0.9001.singularity

This will download a Singularity Image File (SIF) called
**pcgr_2.3.0.9001.singularity.sif** that can be run with Singularity or
Apptainer.
