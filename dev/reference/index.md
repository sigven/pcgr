...
- [`build_germline_col_defs()`](https://sigven.github.io/pcgr/dev/reference/build_germline_col_defs.md)
...
- [`render_acmg_pills_cell()`](https://sigven.github.io/pcgr/dev/reference/render_acmg_pills_cell.md)
  : Render ACMG criteria as individual colored pills (Generated by
  Claude Sonnet 5)
...
- [`render_alteration_classification_style()`](https://sigven.github.io/pcgr/dev/reference/render_alteration_classification_style.md)
  : Style germline alteration cell background based on the
  CPSR/ClinVar-derived clinical significance of the variant (Generated
  by Claude Sonnet 5)
...
- [`render_classification_cell()`](https://sigven.github.io/pcgr/dev/reference/render_classification_cell.md)
  : Render germline clinical significance as a colored badge (Generated
  by Claude Sonnet 5)
...
- [`render_evidence_level_cell()`](https://sigven.github.io/pcgr/dev/reference/render_evidence_level_cell.md)
  ...
  manual tweaks)
- [`render_genotype_style()`](https://sigven.github.io/pcgr/dev/reference/render_genotype_style.md)
  : Flag germline GENOTYPE cell when backed by a low-depth control
  sample (Generated by Claude Sonnet 5)
- [`render_moi_cell()`](https://sigven.github.io/pcgr/dev/reference/render_moi_cell.md)
  : Render CPG_MOI (cancer predisposition gene - mode of inheritance)
  with a tooltip spelling out the abbreviated code(s) (Generated by
  Claude Sonnet 5)
...
- [`strip_html()`](https://sigven.github.io/pcgr/dev/reference/strip_html.md)
  : Strip HTML tags
- [`sync_biomarker_evidence()`](https://sigven.github.io/pcgr/dev/reference/sync_biomarker_evidence.md)
